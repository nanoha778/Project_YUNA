...
def run_talk_command(text: str, G: nx.Graph):
    print(f"[入力]: {text}")
    ...
    print("[第2フェーズ：意味連鎖（20ステップ → 起点語との関連度 >= 0.35）]:")
    ...
    print("[最終フェーズ：意味ネットワークで強く関連する語を抽出]")
    ...
    if meaningful_words:
        print("意味ネットワーク上で強く関連する語（マージ後）:")
        print(list(meaningful_words))
    else:
        print("意味ネットワーク上で強く関連する語は見つかりませんでした。")
    ...
    print("[✔] meaning_network.json に関連度を上書き保存しました。")
